...
const (
	Example_ServerReply_FullMethodName = "/hello.Example/ServerReply"
	Example_NewReply_FullMethodName    = "/hello.Example/NewReply"
)
...
type ExampleClient interface {
	...
	NewReply(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *exampleClient) NewReply(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, Example_NewReply_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ExampleServer interface {
	...
	NewReply(context.Context, *HelloRequest) (*HelloResponse, error)
...
func (UnimplementedExampleServer) NewReply(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Example_NewReply_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExampleServer).NewReply(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Example_NewReply_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExampleServer).NewReply(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Example_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "NewReply",
			Handler:    _Example_NewReply_Handler,
		},
	},
