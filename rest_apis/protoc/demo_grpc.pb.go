...
const (
	Chat_StartChat_FullMethodName = "/demo.chat/StartChat"
)
...
type ChatClient interface {
	StartChat(ctx context.Context, in *AnshResposne, opts ...grpc.CallOption) (*RonakReply, error)
}
...
func (c *chatClient) StartChat(ctx context.Context, in *AnshResposne, opts ...grpc.CallOption) (*RonakReply, error) {
...
type ChatServer interface {
	StartChat(context.Context, *AnshResposne) (*RonakReply, error)
...
func (UnimplementedChatServer) StartChat(context.Context, *AnshResposne) (*RonakReply, error) {
...
func _Chat_StartChat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).StartChat(ctx, req.(*AnshResposne))
	}
